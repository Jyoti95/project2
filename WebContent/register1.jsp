    ...
    <div class="main_container">
      ...
      <div class="right_col" role="main">
        ...
        <!--  <div>
         ...
         <form action="recruiterReg.jsp" method="post">
         <input type="submit" value="Company Registration"/>
         </form>
                ...
                <div class="x_content">
                  ...
                  <form class="form-horizontal form-label-left" novalidate action="register" method="post">
                    ...
                    <div class="item form-group">
                      ...
                      <div class="col-md-6 col-sm-6 col-xs-12">
                        <input id="lname" class="form-control col-md-7 col-xs-12" data-validate-length-range="6"  name="lname"
                placeholder="Last Name" required="required" type="text">
                   ...
                   <div class="item form-group">
                    ...
                    <div class="form-group">
                      ...
                      <div class="col-md-6 col-sm-6 col-xs-12">
                        <input type="date" id="birthday" name="birthday" class="date-picker form-control col-md-7 col-xs-12" required="required" type="text">
                      </div>
