        ...
        <div class="nav_menu">
          <nav class="" role="navigation">
            ...
            <ul class="nav navbar-nav navbar-right">
              <li class="">
              <a href="register1.jsp">Candidate Register</a>
               </li>
              ...
              <li class="">
              <a href="recruiterReg.jsp">Company Register</a>
               </li>
  ...
  <div class="row">
   ...
   <img   src="images/img1.jpg" alt=""  height="200" width="200" >
    ...
    <div class="col-sm-8">
      ...
      <p>A job board is a website that facilitates job hunting and
       range from large scale generalist sites to niche job boards for job 
       categories such as engineering, legal, insurance, social work, teaching,
        mobile app development as well as cross-sector categories such as green 
        jobs, ethical jobs and seasonal jobs. Users can typically deposit their 
        résumés and submit them to potential employers and recruiters for review,
         while employers and recruiters can post job ads and search for potential employees
      </p>
